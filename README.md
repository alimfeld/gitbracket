...
above the two tournament views. The kiosk is a separate mode, reached from the
admin's header link — no public page links to it. The player pick is URL state, never device state — links carry
